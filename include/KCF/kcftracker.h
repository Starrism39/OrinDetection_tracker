...
public:
    ...
    virtual cv::Rect update(cv::Mat image, double distance_threshold, double &cosine_distance);
...
protected:
    ...
    void train(cv::Mat x, float train_interp_factor,double &cosine_distance);
    ...
    cv::Mat _alphaf;
    cv::Mat _alphaf_if_update;
    cv::Mat _prob;
    cv::Mat _tmpl;
    cv::Mat _tmpl_if_update;
    cv::Mat _num;
    cv::Mat _den;
